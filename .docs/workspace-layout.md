...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@s3tools/shared/git`, `@s3tools/shared/DrainableWorker`) — no barrel index.
