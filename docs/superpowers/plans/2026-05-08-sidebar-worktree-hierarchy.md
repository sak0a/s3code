...
import { WorktreeId } from "@ryco/contracts/worktree";
...
import { ProjectId } from "@ryco/contracts";
import { Worktree, WorktreeId } from "@ryco/contracts/worktree";
...
(Import `StatusBucket` from `@ryco/contracts/worktree`.)
...
import { SOURCE_CONTROL_DETAIL_BODY_MAX_BYTES } from "@ryco/contracts/sourceControl";
...
} from "@ryco/contracts/sourceControl";
...
```typescript
import type { StatusBucket } from "@ryco/contracts/worktree";
...
import type { Worktree } from "@ryco/contracts/worktree";
import type { SidebarStatusBucket } from "../Sidebar.logic.ts";
